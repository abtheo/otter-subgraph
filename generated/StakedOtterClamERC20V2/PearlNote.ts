...
export class PearlNote__lockInfosResult {
  value0: BigInt;
  value1: BigInt;
...
export class PearlNote extends ethereum.SmartContract {
  static bind(address: Address): PearlNote {
    return new PearlNote("PearlNote", address);
  }
  ...
  try_burn(tokenId: BigInt): ethereum.CallResult<BigInt> {
  ...
  endEpoch(tokenId: BigInt): BigInt {
    let result = super.call("endEpoch", "endEpoch(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
  ...
  try_endEpoch(tokenId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("endEpoch", "endEpoch(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  lockAmount(tokenId: BigInt): BigInt {
    let result = super.call("lockAmount", "lockAmount(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
  ...
  try_lockAmount(tokenId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("lockAmount", "lockAmount(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  lockInfos(param0: BigInt): PearlNote__lockInfosResult {
    let result = super.call(
      "lockInfos",
      "lockInfos(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new PearlNote__lockInfosResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_lockInfos(
    param0: BigInt
  ): ethereum.CallResult<PearlNote__lockInfosResult> {
    let result = super.tryCall(
      "lockInfos",
      "lockInfos(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new PearlNote__lockInfosResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  mint(_user: Address, _amount: BigInt, _endEpoch: BigInt): BigInt {
    let result = super.call("mint", "mint(address,uint256,uint256):(uint256)", [
      ethereum.Value.fromAddress(_user),
      ethereum.Value.fromUnsignedBigInt(_amount),
      ethereum.Value.fromUnsignedBigInt(_endEpoch)
    ]);
  ...
  paw(): Address {
    let result = super.call("paw", "paw():(address)", []);

    return result[0].toAddress();
  }

  try_paw(): ethereum.CallResult<Address> {
    let result = super.tryCall("paw", "paw():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  unlockedAll(): boolean {
    let result = super.call("unlockedAll", "unlockedAll():(bool)", []);

    return result[0].toBoolean();
  }

  try_unlockedAll(): ethereum.CallResult<boolean> {
    let result = super.tryCall("unlockedAll", "unlockedAll():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class SetPawCall extends ethereum.Call {
  get inputs(): SetPawCall__Inputs {
    return new SetPawCall__Inputs(this);
  }

  get outputs(): SetPawCall__Outputs {
    return new SetPawCall__Outputs(this);
  }
}

export class SetPawCall__Inputs {
  _call: SetPawCall;

  constructor(call: SetPawCall) {
    this._call = call;
  }
...
export class SetPawCall__Outputs {
  _call: SetPawCall;
