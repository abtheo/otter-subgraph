...
export class QiFarm__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class QiFarm__userInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class QiFarm extends ethereum.SmartContract {
  static bind(address: Address): QiFarm {
    return new QiFarm("QiFarm", address);
  }
  ...
  poolInfo(param0: BigInt): QiFarm__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new QiFarm__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_poolInfo(param0: BigInt): ethereum.CallResult<QiFarm__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256,uint16)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  userInfo(param0: BigInt, param1: Address): QiFarm__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new QiFarm__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<QiFarm__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new QiFarm__userInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
