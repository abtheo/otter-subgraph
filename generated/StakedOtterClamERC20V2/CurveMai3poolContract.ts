...
export class CurveMai3poolContract extends ethereum.SmartContract {
  static bind(address: Address): CurveMai3poolContract {
    return new CurveMai3poolContract("CurveMai3poolContract", address);
  }
