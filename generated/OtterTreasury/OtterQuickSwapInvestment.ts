...
export class OtterQuickSwapInvestment__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class OtterQuickSwapInvestment extends ethereum.SmartContract {
  static bind(address: Address): OtterQuickSwapInvestment {
    return new OtterQuickSwapInvestment("OtterQuickSwapInvestment", address);
  }
  ...
  dQuick(): Address {
    let result = super.call("dQuick", "dQuick():(address)", []);

    return result[0].toAddress();
  }

  try_dQuick(): ethereum.CallResult<Address> {
    let result = super.tryCall("dQuick", "dQuick():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getReserves(): OtterQuickSwapInvestment__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new OtterQuickSwapInvestment__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<
    OtterQuickSwapInvestment__getReservesResult
  > {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
    ...
    return ethereum.CallResult.fromValue(
      new OtterQuickSwapInvestment__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  quickStaking(): Address {
    let result = super.call("quickStaking", "quickStaking():(address)", []);

    return result[0].toAddress();
  }

  try_quickStaking(): ethereum.CallResult<Address> {
    let result = super.tryCall("quickStaking", "quickStaking():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
